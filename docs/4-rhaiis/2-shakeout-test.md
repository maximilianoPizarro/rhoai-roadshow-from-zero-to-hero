...
In JupyterLab, open the notebook: <a href="https://github.com/maximilianoPizarro/rhoai-roadshow-from-zero-to-hero/blob/main/docs/4-rhaiis/notebooks/0-validate-environment.ipynb" target="_blank">0-validate-environment.ipynb</a>
